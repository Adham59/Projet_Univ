...
import fr.univlille.info.G3.view.game.menu.ParameterView;
...
public class NewGame extends Button {
    ...
    public NewGame(String imagePath, Stage stage) {
        super("Nouvelle Partie", new ImageView(new Image(imagePath)));
